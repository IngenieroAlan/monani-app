import { DefaultNavigatorOptions, EventMapBase, NavigationState, NavigatorScreenParams, ParamListBase, RouteConfig, RouteGroupConfig, TabNavigationState } from "@react-navigation/native";
